...
Gereksinim analizi aşamasında belirlenen tüm gereksinimler OpenAPI 3.0.3 standartlarına uygun olarak tasarlanmıştır.

🔗 **[temiziz.yaml Dosyasını Görüntülemek İçin Tıklayın](temiziz.yaml)**

---

## OpenAPI YAML İçeriği

Aşağıda API tasarımımızın YAML formatındaki tam içeriği yer almaktadır. Bu içerik [Swagger Editor](https://editor.swagger.io/) üzerinde test edilmiş ve sorunsuz çalışmaktadır:
